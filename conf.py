...
# of the sidebar.
# SET TO UNIVERSITY OF REYKAVIK
html_logo = '_static/HR_logo_hringur.png'

# The name of an image file (within the static path) to use as favicon of the
# docs.  This file should be a Windows icon file (.ico) being 16x16 or 32x32
# pixels large.
# SET TO UNIVERSITY OF REYKJAVIK ICON
html_favicon = '_static/hr_favicon.ico'
...
latex_logo = '_static/HR_logo_hringur_transparent.png'
